                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex; justify-content: space-around;">
                                <button class="btn" style="background-color: #003780; color: white" title="Editar" data-toggle="modal" data-target="#editarModal{{$user->id}}" style="margin-right:5px">
                                        <i class="fa fa-pencil-alt icone"></i>
                                </button>

                                <form action="{{action([App\Http\Controllers\UsuarioController::class, 'destroy'], $user->id)}}" method="POST"  enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    {{method_field('DELETE')}}  
                         ...
                         <!-- Modal de Edição -->
                         <div class="modal fade" id="editarModal{{$user->id}}" tabindex="-1" aria-labelledby="editarModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{action([App\Http\Controllers\UsuarioController::class, 'update'], $user->id)}}" method="POST"  enctype="multipart/form-data">
                                                                {{csrf_field()}}
                                                                {{method_field('PUT')}}
                                            {{csrf_field()}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="admin" value="{{$user->admin}}" name="admin" class="form-control">
                                            </div>
